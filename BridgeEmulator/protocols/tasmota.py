...
def discover(bridge_config, new_lights):
    ...
    logging.device_data("IPS ARE COMMING NOW!!!! SDAFNIOAEKPGFLÖ")
            ...
            if response.status_code == 200:
                ...
                if ("StatusSTS" in device_data):
                    ...
                    if (not device_exist):
                        ...
                        modelid = 'Tasmota-Dimmable' if 'Dimmer' in device_data.StatusSTS else modelid
                        modelid = 'Tasmota-RGB' if 'Color' in device_data.StatusSTS else modelid
